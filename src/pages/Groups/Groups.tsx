...
const SearchingSvg = <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span className={styles["third"]}>.</span>
    ...
    {groups.map((group: Group, key: number) => {
        ...
        variant={current === group.id ? "active" : undefined}
        >
        <WidthSpaced>  
        <Title>
